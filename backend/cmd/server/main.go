...
func main() {
	...
	plotService := service.NewPlotService(plotRepo, transferRepo, db, logger)
	transferService := service.NewPlotTransferService(transferRepo, plotRepo, db, logger)
	...
	plotTransferHandler := handler.NewPlotTransferHandler(transferService, auditService)
	...
	appRouter := router.New(
		cfg, logger, rdb,
		authHandler, userHandler, plotHandler, plotTransferHandler, planHandler, harvestHandler,
